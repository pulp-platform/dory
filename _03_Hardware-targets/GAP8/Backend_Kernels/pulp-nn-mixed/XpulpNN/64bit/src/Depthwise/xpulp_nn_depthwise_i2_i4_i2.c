...
void xpulp_nn_depthwise_i2_i4_i2(
                        int8_t *pIn,
      ...
      do
      {
        ...
        do
        {
          ...
          do
          {
            ...
            *pIm2Col = (int8_t) bitext((int32_t) src_in, 2, 0);
            *pIm2Col2 = (int8_t) bitext((int32_t) src_in, 2, 2);
            *pIm2Col3 = (int8_t) bitext((int32_t) src_in, 2, 4);
            *pIm2Col4 = (int8_t) bitext((int32_t) src_in, 2, 6);
            pIm2Col++;
            pIm2Col2++;
            pIm2Col3++;
            pIm2Col4++;
            *pIm2Col = (int8_t) bitext((int32_t) src_in, 2, 8);
            *pIm2Col2 = (int8_t) bitext((int32_t) src_in, 2, 10);
            *pIm2Col3 = (int8_t) bitext((int32_t) src_in, 2, 12);
            *pIm2Col4 = (int8_t) bitext((int32_t) src_in, 2, 14);
            pIm2Col++;
            pIm2Col2++;
            pIm2Col3++;
            pIm2Col4++;
            *pIm2Col = (int8_t) bitext((int32_t) src_in, 2, 16);
            *pIm2Col2 = (int8_t) bitext((int32_t) src_in, 2, 18);
            *pIm2Col3 = (int8_t) bitext((int32_t) src_in, 2, 20);
            *pIm2Col4 = (int8_t) bitext((int32_t) src_in, 2, 22);
            pIm2Col++;
            pIm2Col2++;
            pIm2Col3++;
            pIm2Col4++;
            *pIm2Col = (int8_t) bitext((int32_t) src_in, 2, 24);
            *pIm2Col2 = (int8_t) bitext((int32_t) src_in, 2, 26);
            *pIm2Col3 = (int8_t) bitext((int32_t) src_in, 2, 28);
            *pIm2Col4 = (int8_t) bitext((int32_t) src_in, 2, 30);
            pIm2Col++;
            pIm2Col2++;
            pIm2Col3++;
            pIm2Col4++;
        ...
        do
        {
          ...
          if (flag_batch_norm && flag_relu)
          {
            ...
            sum3 = pulp_nn_bn_quant_i4(sum3, *(k1 + 2), *(lambda1 + 2), out_shift);
            sum4 = pulp_nn_bn_quant_i4(sum4, *(k1 + 3), *(lambda1 + 3), out_shift);
