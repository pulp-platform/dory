...
void xpulp_nn_pointwise_u4_u2_i8(
                        uint8_t *pIn,
                        ...
                        uint8_t flag_batch_norm)
{
  ...
  for (i_out_y = start_pixel; i_out_y < stop_pixel; i_out_y++)
  {
    ...
    {
      xpulp_nn_im2col_u4_to_u8(pIn + (i_out_x * ch_in_r) + (i_out_y * dim_in_x * ch_in_r), pIm2Col, ch_in<<1);
      pOutBuffer = xpulp_nn_matmul_u4_u2_i8(
          pIm2Col,
          pBias,
          pOutBuffer,
          pOutBuffer + ch_out_r,
