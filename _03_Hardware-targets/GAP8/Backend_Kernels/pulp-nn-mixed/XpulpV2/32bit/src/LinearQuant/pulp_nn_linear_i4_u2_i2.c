                        ...
                        uint8_t flag_batch_norm)
{
    ...
    for(i=start; i<stop; i+=4)
    {
        ...
        for (int j=0; j<(dim_vec >> 4); j++)
        {
          ...
          sum3 = SumDotps4(vecA[0], vecB3[0], sum3);
          sum3 = SumDotps4(vecA[1], vecB3[1], sum3);
          sum3 = SumDotps4(vecA[2], vecB3[2], sum3);
          sum3 = SumDotps4(vecA[3], vecB3[3], sum3);
          sum4 = SumDotps4(vecA[0], vecB4[0], sum4);
          sum4 = SumDotps4(vecA[1], vecB4[1], sum4);
          sum4 = SumDotps4(vecA[2], vecB4[2], sum4);
          sum4 = SumDotps4(vecA[3], vecB4[3], sum4);
          pA+=4;
          pB+=4;
          pB2+=4;
          pB3+=4;
        ...
        while (col_cnt)
        {
          ...
          pA++;
          int8_t inA3 = (int8_t) bitext((int32_t) *pA, 4, 0);
          int8_t inA4 = (int8_t) bitext((int32_t) *pA, 4, 4);
          pA++;
