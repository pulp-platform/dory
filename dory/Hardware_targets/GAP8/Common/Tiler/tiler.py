...
from .tiler_conv2d import Tiler_Conv2D_GAP8 as Tiler_Conv2D
from .tiler_pool2d import Tiler_Pool2D_GAP8 as Tiler_Pool2D
from .tiler_add import Tiler_Add_GAP8 as Tiler_Add
