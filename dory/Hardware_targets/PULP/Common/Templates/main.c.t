...
% endif
  ...
  % endif
      ${prefix}network_run(l2_buffer, ${l2_buffer_size}, l2_buffer, l3_buffer, ${"0" if single_input else "exec"}${f", {prefix}L2_input_h{' + exec * l2_input_size' if not single_input else ''}" if not l3_supported else ""});
