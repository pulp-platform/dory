...
import importlib
Layer2D_writer = importlib.import_module(f'Hardware-targets.Diana.Diana_TVM.Layer2D_template_writer')
ana_enc = importlib.import_module(f'Hardware-targets.Diana.Diana_TVM.weights_encoder_analog')
# Directory
