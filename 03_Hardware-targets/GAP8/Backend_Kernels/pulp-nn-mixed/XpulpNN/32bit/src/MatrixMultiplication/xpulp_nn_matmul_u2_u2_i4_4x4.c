/*
 * xpulp_nn_matmul_u2_u2_i4_4x4.c
...
uint8_t * __attribute__((noinline)) xpulp_nn_matmul_u2_u2_i4_4x4(
                        uint8_t *pIn,
                        int8_t *pBias,
                        uint8_t *pOut,
                        uint8_t *pOut2,
                        ...
                        uint8_t flag_batch_norm)
{
  ...
  for(int i=0; i < (ch_out >> 2); i++)
  {
    ...
    for(int j=0; j<(num_col_im2col >> 3); j++)
    {
      ...
      sum4 = MacLoad8(0, 1, 3, 0, ptrB3, sum4);
      ptrB3 = MacLoadUpdate(ptrB3);
      

      sum5 = MacLoad8(0, 0, 0, 1, ptrA, sum5);
      sum6 = MacLoad8(0, 0, 1, 1, ptrA2, sum6);
      sum7 = MacLoad8(0, 0, 2, 1, ptrA3, sum7);
      sum8 = MacLoad8(0, 1, 3, 1, ptrB4, sum8);
      ptrB4 = MacLoadUpdate(ptrB4);

      sum9  = MacLoad8(0, 0, 0, 0, ptrA, sum9);
      sum10 = MacLoad8(0, 0, 1, 0, ptrA2, sum10);
      sum11 = MacLoad8(0, 0, 2, 0, ptrA3, sum11);
      sum12 = MacLoad8(0, 1, 3, 0, ptrB, sum12);
      ptrB = MacLoadUpdate(ptrB);

      sum13 = MacLoad8(1, 0, 0, 1, ptrA, sum13);
      ptrA  = MacLoadUpdate(ptrA);
      sum14 = MacLoad8(1, 0, 1, 1, ptrA2, sum14);
      ptrA2 = MacLoadUpdate(ptrA2);
      sum15 = MacLoad8(1, 0, 2, 1, ptrA3, sum15);
      ptrA3 = MacLoadUpdate(ptrA3);
      sum16 = MacLoad8(1, 0, 3, 1, ptrA4, sum16);
