...
void xpulp_nn_depthwise_i8_u8_i8(
                        int8_t *pIn,
                        ...
                        uint8_t flag_batch_norm)
{
  ...
  int8_t * pIm2ColBase = pIm2ColBuffer + (core_id * im2col_size);
  ...
  int64_t * k1 = pKappa + core_id * (chunk << 0);
  int64_t * lambda1 = pLambda + core_id * (chunk << 0);
