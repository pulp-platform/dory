...
void xpulp_nn_depthwise_i4_i4_i2(
                        int8_t *pIn,
        ...
        do
        {
          ...
          do
          {
            ...
            *pIm2Col2 = (int8_t) bitext((int32_t) src_in, 4, 28);
            pIm2Col++;
            pIm2Col2++;
            src_in = *((v4s*) (base_ptr + idx + in_image_size));
            *pIm2Col3 = (int8_t) bitext((int32_t) src_in, 4, 0);
            *pIm2Col4 = (int8_t) bitext((int32_t) src_in, 4, 4);
            pIm2Col3++;
            pIm2Col4++;
            *pIm2Col3 = (int8_t) bitext((int32_t) src_in, 4, 8);
            *pIm2Col4 = (int8_t) bitext((int32_t) src_in, 4, 12);
            pIm2Col3++;
            pIm2Col4++;
            *pIm2Col3 = (int8_t) bitext((int32_t) src_in, 4, 16);
            *pIm2Col4 = (int8_t) bitext((int32_t) src_in, 4, 20);
            pIm2Col3++;
            pIm2Col4++;
            *pIm2Col3 = (int8_t) bitext((int32_t) src_in, 4, 24);
            *pIm2Col4 = (int8_t) bitext((int32_t) src_in, 4, 28);
            pIm2Col3++;
            pIm2Col4++;
            idx+=4;
            i++;
