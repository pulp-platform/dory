...
void __attribute__((noinline)) xpulp_nn_linear_i2_i2_i2(
                        int8_t *pIn,
                        int8_t *pBias,
                        int8_t *pOut,
                        int8_t *pWeight,
                        ...
                        uint8_t flag_batch_norm)
{
  ...
  for(i=start; i<stop; i+=4)
  {
    ...
    {
      sum = MacLoads16(1, 0, 0, 0, ptrA, sum);
      ptrA = MacLoadUpdate(ptrA);
      sum2 = MacLoads16(1, 0, 1, 0, ptrA2, sum2);
      ptrA2 = MacLoadUpdate(ptrA2);
      sum3 = MacLoads16(1, 0, 2, 0, ptrA3, sum3);
      ptrA3 = MacLoadUpdate(ptrA3);
      sum4 = MacLoads16(1, 0, 3, 0, ptrA4, sum4);
